...
<head>
    ...
    <title>@yield('title')- TB PDB</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <h3 class="menu-title">DATA PENDUDUK</h3><!-- /.menu-title -->
                    <li>
                        <a href="{{ route('penduduk.index')}}" ><i class="menu-icon fa fa-laptop"></i>Pengelolaan Data Penduduk</a>
                    </li>
                    <li>
                        <a href="{{ route('KartuKeluarga.index') }}" ><i class="menu-icon fa fa-laptop"></i>Pengelolaan Data Kartu Keluarga</a>
                    </li>
                     <li>

                        <a href="{{ url('/laporan')}}" ></i>Laporan</a>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset('style/mages/admin.jpg')}}" alt="User Avatar">
                        </a>
